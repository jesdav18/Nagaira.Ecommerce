...
public interface IAdminRepository
{
    ...
    Task<(int TotalCount, List<Product> Products)> GetProductsPagedAsync(int pageNumber, int pageSize, string? searchTerm = null, bool? isActive = null, Guid? categoryId = null, bool? isFeatured = null);
